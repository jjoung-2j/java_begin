/*
   ...
   자바(Java)라는 프로그램 개발언어를 사용하여 만드는 설계도면을 "클래스" 라고 부른다.
 	...
 	4. 컴파일(compile)하기
 		...
 		javac 를 사용하여 컴파일을 하면 .java 파일이 .class로 생성된다.
...
// 또한 저장시 파일명은 클래스명과 동일하게해야 하며, 확장자는 .java 이다.
// class body(클래스 본체)는 { 로 시작해서 } 로 끝난다.	
	...
	public static void main(String[] args) {
		...
		// System.out 은 모니터 라고 보면 된다.
					/*
					System.out.print("출력하고자 하는 문자열"); 은 모니터에 라고 보면 된다.
		...
		System.out.println("반갑습니다~~ㅎㅎ");
		
		System.out.println("자바 첫날 이군요\n");

		System.out.println("조금 뒤 자기소개를 할 예정입니다. ㅎㅎㅎ");
		
		// 원래모습 java.util.Date now = new java.util.Date();
