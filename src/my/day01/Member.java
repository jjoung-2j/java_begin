 ...
 */
	...
	java.lang.String id;	// String 은 문자열을 뜻하는 클래스이다.
	...
	// id, pwd, name, email 은 instance(인스턴스)변수라고 부른다. - 암기!
	
	/*
		2). static(스태틱) 변수는 동일한 클래스로 생성되어진 서로 다른 instance 들 끼리 공유하는 변수이다.
	*/
	
	static String address; // 주소.  스태틱 변수는 공유됨

	// ============================================================= //
	
/*
    behavior == 행위 == 기능 == method(메소드)
    자바에서 소괄호 () 가 나오는 것은 오로지 딱 2개 밖에 없다. - 암기!
