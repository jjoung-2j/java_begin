...
public class Member_main {
	...
	public static void main(String[] args) {
		...
		// Member_main 클래스와 Member 클래스는 동일한 패키지에 저장된 클래스 이므로 import 를 안 하더라도 사용 가능함.!!  
		
		// 단어와 단어사이를 연결을 지을때 대소문자로 구분짓는 것을 "카멜기법" 이라고 부른다.
		// 예> lssmbr 라고 사용하지 않고 lssMbr 와 같이 쓰는 것.
		
		System.out.println(lssMbr);
		// my.day01.Member@73a28541
		// 패키지명.클래스명@메모리(RAM)상에올라온주소값
		// lssMbr 를 사용하여 my.day01.Member@73a28541 을 제어할 수 있다.
		...
		// 단어와 단어사이를 연결을 지을때 _로 구분짓는 것을 "스네이크기법" 이라고 부른다.
		// 예> eommbr 라고 사용하지 않고 eom_mbr 와 같이 쓰는 것.
		
		System.out.println(eom_mbr);
		// my.day01.Member@6f75e721
		// 패키지명.클래스명@메모리(RAM)상에올라온주소값
		// eom_mbr 를 사용하여 my.day01.Member@6f75e721 을 제어할 수 있다.
	...
	//	lssMbr.address = "서울시 강남구";  이렇게 사용해도 되지만 static 변수는 아래와 같이 클래스명.변수명으로 사용할 것을 권장함. 
        ...
        eom_mbr.id = "eomjh"; // = 은 같다가 아니라 대입해준다라는 말이다.
