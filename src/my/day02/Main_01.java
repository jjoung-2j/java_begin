...
// === 멤버변수와 local(지역)변수의 차이점에 대해서 알아본다. === // Member X
...
public class Main_01 {
	...
	/*
	 	...
	 	문자형인 데이터타입(char)은/는 자동적으로 ' ' 으로 초기화가 되고,
	...
	void info_print() {
		...
		// 지역변수 { } 내에서만 사용되는 것으로 { } 을 벗어나는 순간 지역변수는 자동적으로 메모리(RAM)에서 삭제가 되어진다.!!!!
		int hope_money = 5000;
		String address = "서울시 마포구"; // "" 와 null 와 아에 안준것(오류)은 다름!
