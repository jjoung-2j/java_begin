...
public class Main_wrapper {
	...
	public static void main(String[] args) {
		...
		System.out.println((char)(ch-32));	// (int)ch-32 => 97-32	=> 65	=> A
		
		// Character chr = new Character('a');	// 왠만하면 쓰지 말자.	jdk 1.8버전
		...
		else if('a' <= ch2 && ch2 <= 'z') {	// 소문자인지 알아본다.
			System.out.println(ch2 + " 는 소문자입니다.");
		}
		else if('0' <= ch2 && ch2 <= '9') {	// 숫자인지 알아본다.
		...
		if(Character.isUpperCase(ch2)) {	// 대문자인지 알아본다.
			System.out.println(ch2 + " 는 대문자입니다.");
		}
		...
		char c = input_str.charAt(0);
			...
			char c1 = input_str1.charAt(0);
				if(Character.isUpperCase(c1)) {	// 대문자인지 알아본다.
					System.out.println("첫글자 " + c1 + " 은(는) 대문자입니다.");
				}
				else if(Character.isLowerCase(c1)) {	// 소문자인지 알아본다.
					System.out.println("첫글자 " + c1 + " 은(는) 소문자입니다.");
				}
				else if(Character.isDigit(c1)) {	// 숫자인지 알아본다.
					System.out.println("첫글자 " + c1 + " 은(는) 숫자입니다.");
				}
				// else if(44032 <= (int)c1 && (int)c1 <= 55203 ) { // 한글인지 알아본다.
				else if('가' <= c1 && c1 <= '힣') {	// 한글인지 알아본다.
					System.out.println("첫글자 " + c1 + " 은(는) 한글입니다.");
				}
				else if( c1 == ' ') {	// 공백인지 알아본다.
					System.out.println("첫글자 " + c1 + " 은(는) 공백입니다.");
				}
				else {
					System.out.println("첫글자 " + c1 + " 은(는) 기타문자입니다.");
				}		
