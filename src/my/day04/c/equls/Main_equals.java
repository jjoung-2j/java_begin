...
public class Main_equals {
	...
	public static void main(String[] args) {
		...
		if(str4 == str5) {
			System.out.println("안녕하세요 와 안녕하세요 의 메모리주소가 같습니다.");
		}		
		
		if(str4.equals(str5)) {
			System.out.println("str4의 문자열값과 str5의 문자열값이 같습니다.");
		}
		...
		if(str6.equals(str7)) {
			System.out.println("str6 과 str7의 문자열 값은 같습니다.");
		}
		
		if(str8.equals(str9)) {
			System.out.println("str8 과 str9의 문자열 값은 같습니다.");
		}
