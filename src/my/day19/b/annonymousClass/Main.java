...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("가로 10.5, 세로 5.5 인 면적은 : " + area1_size);
		// 가로 10.5, 세로 5.5 인 면적은 : 57.75
		
		Area area2 = new Area_imple();
		double area2_size = area2.area(20.5, 15.5);
		System.out.println("가로 20.5, 세로 15.5 인 면적은 : " + area2_size);
		// 가로 20.5, 세로 15.5 인 면적은 : 317.75
		
		System.out.println("\n==== 2. 익명(== 무명, annoymous) 클래스 사용시 ====");
		...
		*/
		...
		Area area = new Area() {			// 다른 패키지에서 사용불가능
			@Override
		...
		System.out.println("가로 10.5, 세로 5.5 인 면적은 : " + area_size);
		// 가로 10.5, 세로 5.5 인 면적은 : 57.75
