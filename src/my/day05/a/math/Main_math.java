...
public class Main_math {
	...
	public static void main(String[] args) {
		...
		// 54.0 ==> 54.0 ==> 54
		// 54.1 ==> 55.0 ==> 55 (소수부가 있으면 무조건 올림, 웹에서 주로 이렇게 쓰임) 
		// 54.9 ==> 55.0 ==>55
		...
		System.out.println("db3 => " + (int)Math.ceil(db3) 
						+ ", db4 =>" + (int) Math.ceil(db4) 
						+ ", db5 => " + (int) Math.ceil(db5));
		...
		System.out.println("db3 => " + (int)Math.floor(db3)
						+ ", db4 =>" + (int) Math.floor(db4) 
						+ ", db5 => " + (int) Math.floor(db5));
