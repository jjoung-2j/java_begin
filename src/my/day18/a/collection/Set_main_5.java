...
public class Set_main_5 {
	...
	public static void main(String[] args) {
		System.out.println("\n === HashSet === \n");
	      ...
	      mbr_set.add(new Member("kimth","Qwer1234$","김태희","0105064"));	// 메모리상 주소가 다르다.
	      ...
	      while(itr.hasNext()) {
	         ...
	         System.out.println(mbr);						// 지드래곤은 한번만 나온다.
	      }// end of while---------------------------
	      ...
	      while(itr.hasNext()) {
	         Member mbr = itr.next();
	         if(id.equals(mbr.getId())) {	// id 가 kimth 라면
	            isExist = true;
	            System.out.println(mbr);	// id 가 kimth 인 mbr 
	         }
	      }// end of while---------------------------
