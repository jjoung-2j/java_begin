...
public class ArrayList_main_1 {
	...
	@SuppressWarnings("deprecation")		// 노란색줄 없애기 위한 용도(학습용)
	public static void main(String[] args) {
		/*
		List my_list = new ArrayList();			// ArrayList 안에 interface List 가 있다.
		...
		// 또는
		my_list.add(new Integer(98)); 				// Integer 란 말은 쓰지말라는 말 (jdk 1.8 은 안나온다.)
		my_list.add(Integer.valueOf(100)); 			// 이것을 권장
		my_list.add(80);							// Auto-Boxing 된다.
		// int --> Integer 로 autoBoxing 해준다.
		
		my_list.add(new Double(1234.5)); 			// Double 란 말은 쓰지말라는 말 (jdk 1.8 은 안나온다.)
		my_list.add(Double.valueOf(2345.6)); 		// 이것을 권장
		my_list.add(4345.7);	// double --> Double 로 autoBoxing 해준다.
		
		my_list.add(new Member());					// 객체라면 무조건 다 담을 수 있다.	개수에 제한 X	타입의 제한 X
		
		// == 개수가 무한인지 확인하기 (대충 100 으로 잡기) == //
		for(int i=0; i<91; i++) {
	...
	//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
		// 노란색줄 없애기 용(위에꺼 보기)
		List<Object> my_list = new ArrayList<Object>();			// ArrayList 안에 interface List 가 있다.
		System.out.println("my_list 의 크기 : " + my_list.size());
		// my_list 의 크기 : 0
	...
	//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx	
		...
		for(int i=0; i<9; i++) {
			System.out.println(my_list.get(i));			// 넣자 => add / 꺼내자 => get
		}	// end of for--------------
		/*
			이순신
			엄정화
		...
		System.out.println("\n=== my_list에 저장되어진 데이터 중 정수데이터만 출력하기 === \n");
				
		System.out.println(my_list.get(7));			// index 번호를 모를때 꺼내쓰기 어렵다.
				
		for(int i=0; i<my_list.size(); i++) {
			if(my_list.get(i) instanceof Integer)		// A instanceof B => A가 B라면 true
		...
		// instanceof ~ 뒤에를 정확히 뭘 적을 지 몰라서 불편하다 하소연해서 나온것 => Generic(jdk 1.5부터)
////////////////////////////////////////////////////
	...
	*/		
		...
		// List<String> str_list = new ArrayList<String>();		// JDK 1.8 이전버전
		// List<String> str_list = new ArrayList<>();			// JDK 1.8 이후버전	// 생략가능
